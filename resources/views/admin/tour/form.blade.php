                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group {{ $errors->first('t_title') ? 'has-error' : '' }} ">
                            ...
                            <div>
                                <input type="text" class="form-control"  placeholder="Tiêu đề tour" name="t_title" value="{{ old('t_title',isset($tour) ? $tour->t_title : '') }}">
                            ...
                            <div class="col-sm-12 col-md-6">
                                <div class="form-group">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control"  placeholder="" name="t_type" value="{{ old('t_type',isset($tour) ? $tour->t_type : '') }}">
                                        <span class="text-danger"><p class="mg-t-5">{{ $errors->first('t_type') }}</p></span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-12 col-md-6">
                                <div class="form-group">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control"  placeholder="" name="t_end_gate" value="{{ old('t_end_gate',isset($tour) ? $tour->t_end_gate : '') }}">
                                        <span class="text-danger"><p class="mg-t-5">{{ $errors->first('t_end_gate') }}</p></span>
                                    </div>
                                </div>
                            </div>
                        </div>
