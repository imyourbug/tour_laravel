                                ...
                                @if (!$bookTours->isEmpty())
                                    ...
                                    @foreach($bookTours as $book)
                                        <tr>
                                            ...
                                            <td style="vertical-align: middle; width: 30%" class="title-content">                                            
                                            ...
                                            <td style="vertical-align: middle; width: 17%">
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu action-transaction" role="menu">
                                                        <li><a href="{{ route('book.tour.delete', $book->id) }}" class="btn-confirm-delete"><i class="fa fa-trash"></i>  Xóa</a></li>
