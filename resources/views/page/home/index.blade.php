...
@section('title', 'Cuộc đời là những chuyến đi | BK Travel')
@section('style')
@stop
@section('content')
        ...
        <div class="container">
            <div class="row no-gutters slider-text js-fullheight align-items-center" data-scrollax-parent="true">
                <div class="col-md-7 ftco-animate">
                    <span class="subheading">Welcome to BK Travel</span>
            ...
            <div class="row d-flex">
                <div class="col-md-6 order-md-last heading-section pl-md-5 ftco-animate d-flex align-items-center">
                    <div class="w-100">
                        ...
                        <p>Các bạn hãy tìm đến với BK Travel để được đi đến bất cứ nơi nào trên thế giới. Dành cho người có niềm đam mê bất tận với du lịch!</p>
                            ...
                            @foreach($locations as $location)
                                <div class="item">
                                    <div class="project-destination">
                                        <a href="{{'/tour.html?area=' . $location->id}}" class="img" style="background-image: url({{ $location->l_image ? asset(pare_url_file($location->l_image)) : asset('admin/dist/img/no-image.png') }});">
                                            <div class="text">
            ...
            <div class="row justify-content-center">
                <div class="col-md-12 text-center">
                    <div class="img"  style="background-image: url({{ asset('page/images/bg_2.jpg') }});">
                        <div class="overlay"></div>
                        <h2>Chúng tôi là Công ty Du lịch BK Travel</h2>
